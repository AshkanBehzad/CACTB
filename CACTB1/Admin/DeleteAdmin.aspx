<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DeleteAdmin.aspx.cs" Inherits="CACTB1.Admin.DeleteAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-lg-12 farsi">
            <h1 class="page-header">حذف ادمین</h1>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="table-responsive farsi">
                        ...
                        <asp:GridView ID="grdUserSearched" CssClass="table table-bordered table-hover rtl" runat="server" AutoGenerateColumns="False" OnRowCommand="grdUserSearched_RowCommand" >
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnSetAdmin" CommandArgument='<%#Eval("Mid") %>' CommandName="SetAdmin" runat="server"><i class="fa fa-minus-circle"></i></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
